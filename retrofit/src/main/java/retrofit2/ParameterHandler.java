...
abstract class ParameterHandler<T> {
    ...
    static final class QueryObject<T> extends ParameterHandler<T> {
      ...
      QueryObject(Method method, int p, Retrofit retrofit, Annotation annotation, Annotation[] annotations) {
            this.method = method;
            this.p = p;
        ...
        void apply(RequestBuilder builder, @Nullable T value) throws IOException {
            ...
            for (Map.Entry<String, Object> entry : objectMap.entrySet()) {
                String entryKey = entry.getKey();
                // TODO: Add annotation encode_nulls=true/false
                Object entryValue = entry.getValue();
                Converter<Object, String> converter = retrofit.stringConverter(entryValue.getClass(), annotations);
                String convertedEntryValue = converter.convert(entryValue);
                ...
                builder.addQueryParam(entryKey, convertedEntryValue, true);
            }
        }
    }
